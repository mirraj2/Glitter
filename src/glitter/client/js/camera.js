...
module.exports = function camera (options = {}) {
  let update = function (millis) {
    ...
    if (me) {
      ...
      world.container.x = Math.round(interpolate(world.container.x, w / 2 - (me.x + me.width / 2), millis / 200))
      world.container.y = Math.round(interpolate(world.container.y, h / 2 - (me.y + me.height / 2), millis / 200))
    }
  }
